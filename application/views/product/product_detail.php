            ...
            <div class="span9">
                ...
                <div class="row">
                    <div id="gallery" class="span3">
                        <a href="<?=base_url().$product_info->product_image?>" title="Fujifilm FinePix S2950 Digital Camera">
                            <img src="<?=base_url().$product_info->product_image?>" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
                        </a>
                        <div id="differentview" class="moreOptopm carousel slide">
                            <div class="carousel-inner">
                                <div class="item active">
                                    <a href="<?=base_url().$product_info->product_image?>"> <img style="width:29%" src="<?=base_url().$product_info->product_image?>" alt=""/></a>
                                    <a href="<?=base_url().$product_info->product_image?>"> <img style="width:29%" src="<?=base_url().$product_info->product_image?>" alt=""/></a>
                                    <a href="<?=base_url().$product_info->product_image?>" > <img style="width:29%" src="<?=base_url().$product_info->product_image?>" alt=""/></a>
                                </div>
                                <div class="item">
                            ...
                            <div class="tab-pane fade" id="profile">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="listView">
                                        <div class="row">
                                            <div class="span2">
                                                <img src="<?=base_url().$product_info->product_image;?>" alt=""/>
                                            </div>
                                            <div class="span4">
                                                <h3>New | Available</h3>
                                                <hr class="soft"/>
                                        ...
                                        <div class="row">
                                            <div class="span2">
                                                <img src="<?=base_url()?>assets/themes/images/products/7.jpg" alt=""/>
                                            </div>
                                            <div class="span4">
                                                <h3>New | Available</h3>
                                                <hr class="soft"/>
                                        ...
                                        <div class="row">
                                            <div class="span2">
                                                <img src="<?=base_url()?>assets/themes/images/products/8.jpg" alt=""/>
                                            </div>
                                            <div class="span4">
                                                <h3>New | Available</h3>
                                                <hr class="soft"/>
                                        ...
                                        <div class="row">
                                            <div class="span2">
                                                <img src="<?=base_url()?>assets/themes/images/products/9.jpg" alt=""/>
                                            </div>
                                            <div class="span4">
                                                <h3>New | Available</h3>
                                                <hr class="soft"/>
                                    ...
                                    <div class="tab-pane active" id="blockView">
                                        <ul class="thumbnails">
                                            ...
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details.html"><img src="<?=base_url()?>assets/themes/images/products/12.jpg" alt=""/></a>
                                                    <div class="caption">
                                                        <h5>Manicure &amp; Pedicure</h5>
                                                        <p>
                                                            Lorem Ipsum is simply dummy text.
                                            ...
                                            <li class="span3">
                                                <div class="thumbnail">
                                                    <a href="product_details.html"><img src="<?=base_url()?>assets/themes/images/products/13.jpg" alt=""/></a>
                                                    <div class="caption">
                                                        <h5>Manicure &amp; Pedicure</h5>
                                                        <p>
                                                            Lorem Ipsum is simply dummy text.
